...
WebUI.setText(findTestObject('Object Repository/input_Email_Email'), '123')

WebUI.setEncryptedText(findTestObject('Object Repository/input_Password_Password'), '9NLz+4tGZcQ=')

WebUI.click(findTestObject('Object Repository/div_Password'))
